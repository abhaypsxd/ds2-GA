...
- Abhay Pratap Singh: Conducted quantitative data analysis, provided  sampling technique, descriptive statistics, and also did the same for a sample brand (Toyota). Also provided the graphical analysis for every statistic. (20%)
